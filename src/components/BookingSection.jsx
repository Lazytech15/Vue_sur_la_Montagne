...
// ─── Status states ────────────────────────────────────────────────
// 'idle'     → form shown
// 'loading'  → submitting to workflow
// 'success'  → workflow started, pending admin approval
...
export default function BookingSection() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `${import.meta.env.VITE_WORKER_URL ?? ''}/api/workflow/start`,
        {
          method: 'POST',
      ...
      setBookingId(data.instanceId ?? data.bookingId ?? null);
      setStatus('success');
    } catch (err) {
  ...
  const labelClass =
    'text-xs tracking-widest uppercase flex items-center gap-2';
  const labelStyle = {
    fontFamily: 'Lato, sans-serif',
    ...
    <section id="booking" className="relative z-10 -mt-2 px-4 pb-20">
      <div className="max-w-5xl mx-auto">
          ...
          {status === 'success' && (
            <div className="text-center py-10">
              ...
              <p
                ...
                style={{ fontFamily: 'Lato, sans-serif', color: '#333333', opacity: 0.6 }}
              >
              ...
              {bookingId && (
                <p
                  ...
                  style={{ color: 'rgba(27,54,93,0.45)' }}
                >
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mt-6">
                <button
                  ...
                  onMouseEnter={(e) => {
                    if (status !== 'loading') e.currentTarget.style.background = '#152b4a';
                  }}
                  onMouseLeave={(e) => {
              ...
              <p
                ...
                style={{ fontFamily: 'Lato, sans-serif', color: 'rgba(51,51,51,0.4)' }}
              >
        ...
        <div
          ...
          style={{ border: '1px solid rgba(27,54,93,0.12)', borderTop: 'none' }}
        >
          {[
            ...
            <div
              ...
              style={{
                borderRight: i < 3 ? '1px solid rgba(27,54,93,0.1)' : 'none',
            ...
            >
              <div
                className="text-3xl font-semibold shimmer-sand"
